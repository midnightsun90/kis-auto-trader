...
모의주문 **11건**(삼성전자·카카오·NAVER·기아·현대차, 매수/매도 혼합, 모두 체결)의 주문확인(ODNO)·
공식 체결집계(**총체결 17주 / 3,091,700원 / 추정수수료 1,651원**)·체결 후 잔고(보유 5종목)를 담고
있습니다. (라인별 상세는 모의투자 특성상 T+1 반영 — 다음 영업일 `export_records.py 20260615`
재실행 시 채워집니다.)
